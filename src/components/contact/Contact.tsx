            ...
            <div className="bg-white dark:bg-[#1a1a1a] p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-4 px-6 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold transition-all shadow-md shadow-blue-500/20 disabled:opacity-70 flex items-center justify-center gap-2 group"
                >
                  {isSubmitting ? (
                ...
                {submitStatus === "success" && (
                  <div className="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 flex items-start">
                    <FontAwesomeIcon icon={faCheckCircle} className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
                    <p className="text-green-800 dark:text-green-300 text-sm font-medium">Message sent successfully! I will get back to you soon.</p>
                  </div>
                )}
                
                {submitStatus === "error" && (
                  <div className="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 flex items-start">
                    <FontAwesomeIcon icon={faExclamationCircle} className="w-5 h-5 text-red-500 mt-0.5 mr-3 flex-shrink-0" />
                    <p className="text-red-800 dark:text-red-300 text-sm font-medium">Something went wrong. Please try again or email me directly.</p>
                  </div>
                )}
